...
const Button = ({ children }) => {
  ...
  const { contextSafe } = useGSAP(() => {
    ...
    //   { xPercent : 22, scaleX : 0, transformOrigin: "right" },
    //   0
    // )
    .from(".slidebutton", 
      { xPercent: -100, scaleX: 1 },
      // { xPercent: 22, scaleX: 1 }, // Move first, no shrinking yet
      0
    )
    .to(".slidebutton", 
      { scaleX: 0, transformOrigin: "right" }, 
      0.3 // Shrink starts at 80% of the timeline
    )
  ...
  return (
    ...
    href="" 
    className="bg-white text-[#640000] w-48 h-16 text-sm !mt-10 font-semibold relative !p-0 !m-0 overflow-hidden">
